			...
			<table width="900" border="0"">
				...
				<tr>
					<td height="29" bgcolor="#6C7B8B">
						<span class="STYLE1">当前位置：<a href="emploe_table.jsp" class="STYLE1">基本信息</a> &gt;&gt; <a href="news_table.jsp" class="STYLE1">留言消息管理</a>&gt;&gt; 发布消息</span>	
					</td>
					<td height="29" bgcolor="#6C7B8B" align="right">
						<span class="STYLE1">当前用户：<%=session.getAttribute("mname")%></span>
						<input type="button" name="back" value="退出登陆">
					</td>	
				</tr>
				<tr>
					<td height="254" align="center" colspan="2">
						<form action="../ManagerNewsAdd" method="post" onSubmit="return emploe_validate()">
